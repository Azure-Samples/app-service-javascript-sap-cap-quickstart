...
In this example we use the [Azure Developer CLI (azd)](https://github.com/Azure/azure-dev) to deploy the project. Learn more about this tool on [Microsoft Learn](https://learn.microsoft.com/azure/developer/azure-developer-cli/overview)
...
Besides `Bicep` the `azd` CLI also supports the definition of the infrastructure via [Terraform](https://www.terraform.io/) as an *beta feature*. Get started with Terraform modules from [this](https://github.com/Azure-Samples/app-service-javascript-sap-cloud-sdk-quickstart/blob/main/documentation/DEPLOYMENT-AZD-TERRAFORM.md) "sister-project" using SAP Cloud SDK.
