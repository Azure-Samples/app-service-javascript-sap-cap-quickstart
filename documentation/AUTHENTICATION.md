...
## Entra ID user attribute mapping to SAP CAP CDS authorization

Using the npm module [cds-entra-id](https://www.npmjs.com/package/cds-entra-id) this project enables usage of Entra ID app roles attached to the Azure App Service for SAP CAP CDS authorization. The module maps the Entra ID user attributes to the SAP CAP CDS authorization model.

This approach allows fine grained security control on the SAP CDS level driven by Microsoft Entra ID.
