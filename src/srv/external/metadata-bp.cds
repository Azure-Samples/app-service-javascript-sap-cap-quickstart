/* checksum : 13d5cbac91256e6ff1c81d47ddf1306a */
@cds.external : true
...
entity s4_bp.A_AddressEmailAddress {
...
entity s4_bp.A_AddressFaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity s4_bp.A_AddressHomePageURL {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity s4_bp.A_AddressPhoneNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity s4_bp.A_BPAddrDepdntIntlLocNumber {
  @sap.display.format : 'UpperCase'
...
entity s4_bp.A_BPContactToAddress {
  @sap.display.format : 'UpperCase'
  ...
  to_EmailAddress : Association to many s4_bp.A_AddressEmailAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_FaxNumber : Association to many s4_bp.A_AddressFaxNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_MobilePhoneNumber : Association to many s4_bp.A_AddressPhoneNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_PhoneNumber : Association to many s4_bp.A_AddressPhoneNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_URLAddress : Association to many s4_bp.A_AddressHomePageURL {  };
};
...
entity s4_bp.A_BPContactToFuncAndDept {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity s4_bp.A_BuPaAddressUsage {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity s4_bp.A_BuPaIdentification {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Business Partner'
entity s4_bp.A_BusinessPartner {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
  ...
  @cds.ambiguous : 'missing on condition?'
  to_BuPaIdentification : Association to many s4_bp.A_BuPaIdentification {  };
  @cds.ambiguous : 'missing on condition?'
  to_BuPaIndustry : Association to many s4_bp.A_BuPaIndustry {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerAddress : Association to many s4_bp.A_BusinessPartnerAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerBank : Association to many s4_bp.A_BusinessPartnerBank {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerContact : Association to many s4_bp.A_BusinessPartnerContact {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerRole : Association to many s4_bp.A_BusinessPartnerRole {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerTax : Association to many s4_bp.A_BusinessPartnerTaxNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusPartAddrDepdntTaxNmbr : Association to many s4_bp.A_BusPartAddrDepdntTaxNmbr {  };
  @cds.ambiguous : 'missing on condition?'
  to_Customer : Association to s4_bp.A_Customer {  };
  @cds.ambiguous : 'missing on condition?'
  to_Supplier : Association to s4_bp.A_Supplier {  };
};
...
@sap.content.version : '1'
@sap.label : 'Address'
entity s4_bp.A_BusinessPartnerAddress {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
  ...
  @cds.ambiguous : 'missing on condition?'
  to_AddressUsage : Association to many s4_bp.A_BuPaAddressUsage {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPAddrDepdntIntlLocNumber : Association to s4_bp.A_BPAddrDepdntIntlLocNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_EmailAddress : Association to many s4_bp.A_AddressEmailAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_FaxNumber : Association to many s4_bp.A_AddressFaxNumber {  };
...
@sap.content.version : '1'
@sap.label : 'Bank'
entity s4_bp.A_BusinessPartnerBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Contact'
entity s4_bp.A_BusinessPartnerContact {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
  ...
  RelationshipCategory : String(6);
  @cds.ambiguous : 'missing on condition?'
  to_ContactAddress : Association to many s4_bp.A_BPContactToAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_ContactRelationship : Association to s4_bp.A_BPContactToFuncAndDept {  };
};
...
@sap.content.version : '1'
@sap.label : 'Role'
entity s4_bp.A_BusinessPartnerRole {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity s4_bp.A_BusinessPartnerTaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity s4_bp.A_BusPartAddrDepdntTaxNmbr {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity s4_bp.A_CustAddrDepdntExtIdentifier {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
...
entity s4_bp.A_CustAddrDepdntInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity s4_bp.A_Customer {
  ...
  County : String(3);
  @cds.ambiguous : 'missing on condition?'
  to_CustAddrDepdntExtIdentifier : Association to many s4_bp.A_CustAddrDepdntExtIdentifier {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustAddrDepdntInformation : Association to many s4_bp.A_CustAddrDepdntInformation {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerCompany : Association to many s4_bp.A_CustomerCompany {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerSalesArea : Association to many s4_bp.A_CustomerSalesArea {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerTaxGrouping : Association to many s4_bp.A_CustomerTaxGrouping {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerText : Association to many s4_bp.A_CustomerText {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerUnloadingPoint : Association to many s4_bp.A_CustomerUnloadingPoint {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustUnldgPtAddrDepdntInfo : Association to many s4_bp.A_CustUnldgPtAddrDepdntInfo {  };
};
...
entity s4_bp.A_CustomerCompany {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  CustomerAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_CompanyText : Association to many s4_bp.A_CustomerCompanyText {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerDunning : Association to many s4_bp.A_CustomerDunning {  };
  @cds.ambiguous : 'missing on condition?'
  to_WithHoldingTax : Association to many s4_bp.A_CustomerWithHoldingTax {  };
};
...
entity s4_bp.A_CustomerCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  @sap.creatable : 'false'
...
entity s4_bp.A_CustomerDunning {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity s4_bp.A_CustomerSalesArea {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  CustomerAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_PartnerFunction : Association to many s4_bp.A_CustSalesPartnerFunc {  };
  @cds.ambiguous : 'missing on condition?'
  to_SalesAreaTax : Association to many s4_bp.A_CustomerSalesAreaTax {  };
  @cds.ambiguous : 'missing on condition?'
  to_SalesAreaText : Association to many s4_bp.A_CustomerSalesAreaText {  };
  @cds.ambiguous : 'missing on condition?'
  to_SlsAreaAddrDepdntInfo : Association to many s4_bp.A_CustSlsAreaAddrDepdntInfo {  };
};
...
entity s4_bp.A_CustomerSalesAreaTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  @cds.ambiguous : 'missing on condition?'
  to_SlsAreaAddrDepdntTax : Association to many s4_bp.A_CustSlsAreaAddrDepdntTaxInfo {  };
};
...
entity s4_bp.A_CustomerSalesAreaText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  @sap.creatable : 'false'
...
entity s4_bp.A_CustomerTaxGrouping {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  @sap.creatable : 'false'
...
entity s4_bp.A_CustomerUnloadingPoint {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity s4_bp.A_CustomerWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity s4_bp.A_CustSalesPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity s4_bp.A_CustSlsAreaAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity s4_bp.A_CustSlsAreaAddrDepdntTaxInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity s4_bp.A_CustUnldgPtAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity s4_bp.A_Supplier {
  ...
  @cds.ambiguous : 'missing on condition?'
  to_SupplierCompany : Association to many s4_bp.A_SupplierCompany {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierPurchasingOrg : Association to many s4_bp.A_SupplierPurchasingOrg {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierText : Association to many s4_bp.A_SupplierText {  };
};
...
entity s4_bp.A_SupplierCompany {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
  ...
  SupplierAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_CompanyText : Association to many s4_bp.A_SupplierCompanyText {  };
  @cds.ambiguous : 'missing on condition?'
  to_Supplier : Association to s4_bp.A_Supplier {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierDunning : Association to many s4_bp.A_SupplierDunning {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierWithHoldingTax : Association to many s4_bp.A_SupplierWithHoldingTax {  };
};
...
entity s4_bp.A_SupplierCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  @sap.creatable : 'false'
...
entity s4_bp.A_SupplierDunning {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity s4_bp.A_SupplierPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity s4_bp.A_SupplierPurchasingOrg {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  ...
  SupplierAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_PartnerFunction : Association to many s4_bp.A_SupplierPartnerFunc {  };
  @cds.ambiguous : 'missing on condition?'
  to_PurchasingOrgText : Association to many s4_bp.A_SupplierPurchasingOrgText {  };
};
...
entity s4_bp.A_SupplierPurchasingOrgText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  @sap.creatable : 'false'
...
entity s4_bp.A_SupplierWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
